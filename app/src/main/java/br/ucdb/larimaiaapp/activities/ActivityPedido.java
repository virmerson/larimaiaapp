...
public class ActivityPedido extends AppCompatActivity {
        ...
        ApiWeb.getRotas().salvarPedido(pedido, new Callback<Pedido>() {
            ...
            public void success(Pedido ped, Response response) {
                ...
                origem.setText(null);
                 ...
                 textCerimonial.setText(null);

                 horaEvento.setText(null);

                 dataEvento.setText(null);

                 dataPedido.setText(null);

                 indicacao.setText(null);
   ...
   /* final ItemPedido ip = new ItemPedido();
    ...
    public void salvar(){
        ...
        ip.setQuantidade(Integer.parseInt(quantidade.getText().toString()));
        listaIP.add(ip);

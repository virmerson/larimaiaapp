 ...
 */
public class Pedido {
    private String indicacao, obs, localContrato, hora, evento, rua, bairro, cep, cidade, estado, complemento, cerimonial;
    ...
    public String getCerimonial() {return cerimonial;}

    public void setCerimonial(String cer) {cerimonial = cer;}
